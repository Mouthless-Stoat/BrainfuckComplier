...
def runBFcode(sourceCode: str =  "main.py", runFile: bool = True, debugMode: bool = False, memoryStringLenght: int = 100, cycleCap: int = 10000, noCap: bool = False):
...
runBFcode("main.bf", True, noCap=True, debugMode=True)
